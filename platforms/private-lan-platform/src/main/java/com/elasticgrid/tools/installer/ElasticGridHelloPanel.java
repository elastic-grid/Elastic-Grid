 ...
 * @author Dan T. Tran
 */
public class ElasticGridHelloPanel extends IzPanel {
     ...
     */
    public ElasticGridHelloPanel(InstallerFrame parent, InstallData idata) {
    ...
    public ElasticGridHelloPanel(InstallerFrame parent, InstallData idata, LayoutManager2 layout) {
