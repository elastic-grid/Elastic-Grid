...
set classpath=-cp %RIO_HOME%\lib\boot.jar;%JINI_HOME%\lib\start.jar;%JAVA_HOME%\lib\tools.jar;%EG_HOME%\lib\elastic-grid\kernel\elastic-grid-core-${pom.version}.jar
