...
public class RemoteRepositoryTest extends AbstractTestNGSpringContextTests {
    ...
    public void testLoad() throws IOException {
        ...
        manager.save(app);
        manager.publishApplication(app);
        assertEquals(repository.getGrids().size(), 0);
    ...
    @BeforeClass
    public void setupLocalRepository() throws IOException {
        repository = (RemoteRepository) applicationContext.getBean("remoteRepository", RemoteRepository.class);
