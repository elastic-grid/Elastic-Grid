...
public class LANCloudPlatformManagerFactory implements CloudPlatformManagerFactory<LANCluster> {
    public CloudPlatformManager<LANCluster> getInstance() {
        LANCloudPlatformManager lanCloudPlatformManager = new LANCloudPlatformManager();
        lanCloudPlatformManager.setClusterLocator(new JiniGroupsClusterLocator());
        return lanCloudPlatformManager;
    }
}
